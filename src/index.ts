...
function createAnimations() {
    ...
    animationManager.createAnimation('goblin_walk', goblinSprite1, 2, 1, walkFrames, true);
    ...
    animationManager.createAnimation('goblin_attack', goblinSprite2, 2, 1, attackFrames, true);
    animationManager.createAnimation('goblin_stand', goblinSprite1, 2, 19, 19, true);
